      ...
      <div style={{ position: 'absolute', top: 16, right: 16, zIndex: 50, display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        >
          <div className="guide-extra">
            ...
            <div className="guide-subsection" style={{ marginTop: 32, padding: 16, background: 'rgba(255,126,95,0.05)', borderRadius: 12, border: '1px solid rgba(255,126,95,0.2)', textAlign: 'center' }}>
              <p style={{ fontSize: 13, color: 'var(--text-muted)', marginBottom: 12 }}>{t('tutor.help')}</p>
              <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
                <a href="https://wa.me/6285764948010" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#ff7e5f', textDecoration: 'none', fontWeight: 600, fontSize: 12, background: 'rgba(255,126,95,0.1)', padding: '6px 12px', borderRadius: 100, border: '1px solid rgba(255,126,95,0.2)' }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                  WhatsApp
                </a>
                <a href="https://www.instagram.com/ar__lii?igsh=ZWhsZWZqZ21vcnEx" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#ff7e5f', textDecoration: 'none', fontWeight: 600, fontSize: 12, background: 'rgba(255,126,95,0.1)', padding: '6px 12px', borderRadius: 100, border: '1px solid rgba(255,126,95,0.2)' }}>
                ...
                <a href="mailto:rafaelpututarli@gmail.com" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#ff7e5f', textDecoration: 'none', fontWeight: 600, fontSize: 12, background: 'rgba(255,126,95,0.1)', padding: '6px 12px', borderRadius: 100, border: '1px solid rgba(255,126,95,0.2)' }}>
