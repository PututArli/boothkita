...
export default function PhotoboothRoom({ roomId, roomCode, roomExpiresAt }: Props) {
  ...
  return (
    <>
      ...
      {/* Global Bottom-Left Utilities (Language & Fullscreen) — draggable */}
      <DraggableWidget storageKey="room-bottom-util" defaultX={24} defaultY={9999} mode="fixed" style={{ zIndex: 90 }}>
